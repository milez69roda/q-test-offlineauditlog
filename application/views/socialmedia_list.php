	...
	<script>
		...
		$(document).ready(function() {
			...
			oTable = $('#example').dataTable( {
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "client/ajax_get_socialmedia",				
				"oLanguage": {
	...
	<div class="row-fluid">
		...
		<div class="row" style="text-align:center">
			...
			<button type="button" class="btn btn-success" onclick="COMMON.exportexcel('social_media')">Export</button>	
		</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" >
			<thead>
				<tr>
					<th>Review Date</th>
					<th>Agent ID </th>
					<th>Parature Ticket #</th>
					<th>Post/Tweet/Ticket Handling</th>
					<th>Procedures</th>
					<th>Resolution</th>
					<th>Documentation</th>
					<th>Grammar</th> 
					<th>Auto-Fail</th>
					<!--<th>Auto Fail Comments</th>-->
					<th>Score</th>
					<th>Comments</th>
