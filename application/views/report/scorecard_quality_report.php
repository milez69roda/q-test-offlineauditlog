...
<div class="row-fluid" style="">
	...
	<div class="row" style="text-align:left">
		...
		<form id="form1" name="form1" action="<?php echo base_url(); ?>scorecard/qualityreport/" method="GET">
		...
		<button type="button" class="btn btn-success" onclick="COMMON.report_exportexcel('scorecard_quality')">Export</button>
		</form>	 	
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example"  >
			<thead>
				<tr>
					...
					<th>Sum of Audit Score</th>
					<th>Sum of Audit Potential Score</th>
					<th>% Score</th> 
				</tr>
			</thead>
			<tbody>	
