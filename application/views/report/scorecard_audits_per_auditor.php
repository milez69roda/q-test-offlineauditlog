...
<div class="row-fluid" style="">
	<?php echo $nav; ?>  
	<h4 class="text-center">Audits per Auditor per Day Report</h4>
	
	<div class="row" style="text-align:left">
		
		<form id="form1" name="form1" action="<?php echo base_url(); ?>scorecard/audits/" method="GET">
		...
		<button type="button" class="btn btn-success" onclick="COMMON.report_exportexcel('scorecard_audits')">Export</button>
		</form>	 	
