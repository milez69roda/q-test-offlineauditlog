	...
	<script>
		...
		$(document).ready(function() {
			...
			oTable = $('#example').dataTable({
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "client/ajax_get_kanaemail",				
				"oLanguage": {
	...
	<div class="row-fluid" >
		...
		<div class="row" style="text-align:center">
			...
			<button type="button" class="btn btn-success" onclick="COMMON.exportexcel('kana_email')">Export</button>	
		</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example"  >
			<thead>
				<tr>
					...
					<th>Kana Email ID</th>
					<th>Agent correctly identified and address customers concern with all the necessary information?	</th>
					<th>Did the agent present an applicable solution?</th>
					<th>Spelling/Grammer: Were all words spelled correctly and message content follow correct grammar guidelines</th>
					...
					<th>Was email routed correctly?</th>
